	...
	issues: [
		{
			...
			suggestion:
				"Use 'authentication' instead of 'login' for consistency",
		},
		{
			type: 'phrasing',
			...
			variants: [
				{
					phrase: 'session expires after 1 hour',
					file: 'docs/api/auth.md',
				},
				{
					phrase: 'sessions last 60 minutes',
	...
	results: [
		{
			...
			relevance: 0.95,
			snippet:
				'...authentication flow starts when the client submits credentials...',
		...
		},
		{
			...
			relevance: 0.87,
			snippet:
				'...authenticateUser function handles the authentication flow...',
			section: 'Examples',
		},
	];
}
...
**Next:** [Planning Layer](./PLANNING.md) - Task planning with automatic validation
